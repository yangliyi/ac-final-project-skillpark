...
RSpec.describe Admin::CommentsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all admin_comments as @admin_comments" do
      ...
      expect(assigns(:admin_comments)).to eq([comment])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested admin_comment as @admin_comment" do
      ...
      expect(assigns(:admin_comment)).to eq(comment)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_comment as @admin_comment" do
      ...
      expect(assigns(:admin_comment)).to be_a_new(Admin::Comment)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created admin_comment as @admin_comment" do
        post :create, {:admin_comment => valid_attributes}, valid_session
        expect(assigns(:admin_comment)).to be_a(Admin::Comment)
        expect(assigns(:admin_comment)).to be_persisted
      end

      it "redirects to the created admin_comment" do
        post :create, {:admin_comment => valid_attributes}, valid_session
        expect(response).to redirect_to(Admin::Comment.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved admin_comment as @admin_comment" do
        post :create, {:admin_comment => invalid_attributes}, valid_session
        expect(assigns(:admin_comment)).to be_a_new(Admin::Comment)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_comment" do
        comment = Admin::Comment.create! valid_attributes
        put :update, {:id => comment.to_param, :admin_comment => new_attributes}, valid_session
        comment.reload
    ...
    context "with invalid params" do
      it "assigns the admin_comment as @admin_comment" do
        comment = Admin::Comment.create! valid_attributes
        put :update, {:id => comment.to_param, :admin_comment => invalid_attributes}, valid_session
        expect(assigns(:admin_comment)).to eq(comment)
      end
